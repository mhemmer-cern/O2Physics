...
struct TrackMatchingMonitor {
  ...
  void init(InitContext const&)
  {
    ...
    mHistManager.add("clusterTM_NSigma_e", "NSigma electron", o2HistType::kTH3F, {nSigmaAxis, trackptAxis, nmatchedtrack});                                                           // E over p vs track pT for the Nth closest electron track
    mHistManager.add("clusterTM_NSigma_p", "NSigma positron", o2HistType::kTH3F, {nSigmaAxis, trackptAxis, nmatchedtrack});                                                           // E over p vs track pT for the Nth closest positron track
    mHistManager.add("clusterTM_NSigma_electron_ASide", "NSigma electron in A-Side", o2HistType::kTH3F, {nSigmaAxis, trackptAxis, nmatchedtrack});                                    // E over p vs track pT for the Nth closest electron/positron track in A-Side
    mHistManager.add("clusterTM_NSigma_electron_CSide", "NSigma positron in C-Side", o2HistType::kTH3F, {nSigmaAxis, trackptAxis, nmatchedtrack});                                    // E over p vs track pT for the Nth closest electron/positron track in C-Side
