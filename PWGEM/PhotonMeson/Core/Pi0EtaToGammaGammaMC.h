...
using namespace o2::framework; // needed for PROCESS_SWITCH until fixed!
...
// using MyCollisions = o2::soa::Join<aod::EMEvents, aod::EMEventsMult, aod::EMEventsCent, aod::EMMCEventLabels>;
// using MyCollisionsWithJJMC = o2::soa::Join<MyCollisions, aod::EMEventsWeight>;
// using MyMCCollisions = o2::soa::Join<aod::EMMCEvents, aod::BinnedGenPts>;
// using MyV0Photons = o2::soa::Filtered<o2::soa::Join<aod::V0PhotonsKF, aod::V0KFEMEventIds, aod::V0PhotonsKFPrefilterBitDerived>>;
// using MyEMCClusters = o2::soa::Join<aod::SkimEMCClusters, aod::EMEMCClusterMCLabels, aod::EMCEMEventIds>;
// using MyPHOSClusters = o2::soa::Join<aod::PHOSClusters, aod::PHOSEMEventIds>;
// using MyMCElectrons = o2::soa::Filtered<o2::soa::Join<aod::EMPrimaryElectronsFromDalitz, aod::EMPrimaryElectronEMEventIds, aod::EMPrimaryElectronsPrefilterBitDerived, aod::EMPrimaryElectronMCLabels>>;
