...
class EMCPhotonCut : public TNamed
{
 public:
  ...
  template <typename Cluster, typename TMatchedTracks = std::nullptr_t, typename TMatchedSecondaries = std::nullptr_t>
  ...
  template <typename Cluster, typename TMatchedTracks = std::nullptr_t>
